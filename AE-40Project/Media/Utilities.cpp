...
LPCWSTR Utilities::GetGUIDNameConst(const GUID & guid)
{
...
HRESULT Utilities::GetGUIDName(const GUID & guid, WCHAR ** ppwsz)
{
	HRESULT hr = S_OK;
	WCHAR *pName = NULL;
...
HRESULT Utilities::LogAttributeValueByIndex(IMFAttributes * pAttr, DWORD index)
{
...
HRESULT Utilities::SpecialCaseAttributeValue(GUID guid, const PROPVARIANT & var)
{
...
void Utilities::DBGMSG(PCWSTR format, ...)
{
	va_list args;
...
HRESULT Utilities::LogMediaType(IMFMediaType * pType)
{
	UINT32 count = 0;
...
void Utilities::LogUINT32AsUINT64(const PROPVARIANT & var)
{
...
float Utilities::OffsetToFloat(const MFOffset & offset)
{
	return offset.value + (static_cast<float>(offset.fract) / 65536.0f);
}

HRESULT Utilities::LogVideoArea(const PROPVARIANT & var)
{
